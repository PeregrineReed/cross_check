class Team
  ...
  def league_win_percentage
    total_wins_league / total_games_league
  end

  def league_home_win_percentage
    home_wins_league / total_games_league
  end

  def league_away_win_percentage
    away_wins_league / total_games_league
  end

  def fans_rating
    league_home_win_percentage - league_away_win_percentage
  end

  def league_away_average_goals
    away_goals_league / total_games_league
  end

  def league_home_average_goals
    home_goals_league / total_games_league
  end
