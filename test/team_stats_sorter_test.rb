...
class TeamStatSorterTest < Minitest::Test
  ...
  def test_it_exists
    assert_instance_of TeamStatSorter, @team_stat_sorter
  end

  def test_it_has_games
    assert_equal @games, @team_stat_sorter.games
  end
  ...
  def test_it_sorts_team_league_games
    @team_stat_sorter.sort_total_league_games
  ...
  def test_it_sorts_team_season_games
    skip
    @team_stat_sorter.sort_total_season_games

    assert_equal 2, @team_6.total_wins_preseason
    assert_equal 2, @team_6.total_games_preseason
    assert_equal 2, @team_6.total_goals_preseason
    assert_equal 10, @team_3.total_goals_allowed_preseason
